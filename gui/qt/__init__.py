...
from electrum_peseta import WalletStorage, Wallet
from electrum_peseta.pesetacoin import MIN_RELAY_TX_FEE
...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit Electrum-PESETA"), self.close)
    ...
    def init_lite(self):
        ...
        if not self.check_qt_version():
            if self.config.get('lite_mode') is True:
                msg = "Electrum-PESETA was unable to load the 'Lite GUI' because it needs Qt version >= 4.7.\nChanging your config to use the 'Classic' GUI"
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-PESETA')
